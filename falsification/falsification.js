...
const ahadithsFalsificationOrdreRevelation = [
  {
    ...
    numero: 3758,
    texteArabe: " استَقرِئوا القُرآنَ مِن أربَعةٍ",
    texteFrancais: "",
...
const ahadithsFalsificationOubli = [
  {
    ...
    auteur: "El Boukhari  صحيح  البخاري",
    numero: 5042,
    texteArabe: "أذكرَني آيةً كنتُ أُنسيتُها",
    texteFrancais: "",
  ...
  },
  {
    ...
    auteur: "El Boukhari  صحيح  البخاري",
    numero: 5032,
    texteArabe: "بِئْسَ ما لأحَدِهِمْ أنْ يَقُولَ: نَسِيتُ آيَةَ",
    texteFrancais: "",
  ...
  },
  {
    ...
    auteur: "El Boukhari  صحيح  البخاري",
    numero: 401,
    texteArabe: " إنما أنا بشرٌ ، أَنسى كما تنسَون ، فإذا نسيتُ فذَكِّروني",
    texteFrancais: "",
...
const ahadithsFalsificationOmarCoran = [
  ...
  },
  {
    ...
    auteur: "El Boukhari  صحيح  البخاري",
    numero: 4890,
    texteArabe: " لا أدْرِي الآيَةَ في الحَديثِ أوْ قَوْلُ عَمْرٍو ",
    texteFrancais: "",
  ...
  },
  {
    ...
    auteur: "El Boukhari  صحيح  البخاري",
    numero: 3242,
    texteArabe: " قُلتُ: لِمَن هذا القَصْرُ؟ قالوا: لِعُمَرَ بنِ الخَطَّابِ",
    texteFrancais: "",
  ...
  },
  {
    ...
    auteur: "El Boukhari  صحيح  البخاري",
    numero: 4795,
    texteArabe: " إنَّه قدْ أُذِنَ لَكُنَّ أنْ تَخْرُجْنَ لِحَاجَتِكُنَّ.",
    texteFrancais: "",
...
const ahadithsFalsificationSeptLectures = [
  ...
  },
  {
    ...
    numero: 3743,
    texteArabe:
      " هؤلاء يُريدوني على أن أقرَأ: {وما خَلَقَ الذَّكَرَ والأُنثى} واللهِ لا أُتابِعُهم.",
    texteFrancais: "",
...
const ahadithsFalsificationCoranIncomplet = [
  ...
  },
  {
    ...
    numero: 6838,
    texteArabe:
      " لا ترغَبوا عن آبائِكم فإنَّ كفرًا بكم أنْ ترغَبوا عن آبائِكم ",
    texteFrancais: "",
  ...
  },
  {
    ...
    texteArabe: "المعوذتين ليستا من كتاب الله",
    texteFrancais: "",
