...
const ahadithsRamadhan = [
  ...
  },
  {
    ...
    numero: 506,
    texte:
      " أُحِلَّ لَكُمْ لَيْلَةَ الصِّيَامِ الرَّفَثُ إِلَى نِسَائِكُمْ} [البقرة: 187]",
...
const ahadithsAumone = [
  ...
  },
  {
    auteur: "صحيح البخاري",
    numero: 3276,
    texte:" يَأْتي الشَّيْطانُ أحَدَكُمْ فَيَقُولَ: مَن خَلَقَ كَذا وكَذا؟ حتَّى يَقُولَ له: مَن خَلَقَ رَبَّكَ؟ فإذا بَلَغَ ذلكَ، فَلْيَسْتَعِذْ باللَّهِ ولْيَنْتَهِ.",
