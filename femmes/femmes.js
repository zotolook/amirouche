...
// 6. Les comparaisons
const souratesFemmesComparaison = ["La femme ... débile !",4, "La femme ... diable!",4, "La femme ... les excréments !",5, ];
const versetsFemmesComparaison= ["", 5,"", 117, "",6,];
...
// 8- le voile
const souratesFemmesVoile = [24, "Maharims", 33,];
const versetsFemmesVoile = [31, "", 55, ];
const ahadithsFemmesVoile = [];

// 9- L'autorité de l'homme sur la femme
const souratesFemmesAutorite = ["L'homme a autorité sur la femme...", 4,];
const versetsFemmesAutorite = ["L'homme peut frapper son épouse", 34,];
